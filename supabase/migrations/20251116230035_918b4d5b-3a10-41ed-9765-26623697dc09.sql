-- Drop all versions of admin_get_teachers
DROP FUNCTION IF EXISTS public.admin_get_teachers(text, text, integer, integer, text, text, text, text);
DROP FUNCTION IF EXISTS public.admin_get_teachers(uuid, text, integer, integer, text, text, text, text);

-- Create single unified version with photo_url
