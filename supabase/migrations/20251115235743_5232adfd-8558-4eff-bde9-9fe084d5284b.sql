-- Drop the old version of admin_get_teachers function with 6 parameters
DROP FUNCTION IF EXISTS public.admin_get_teachers(uuid, text, integer, integer, text, text);

-- Ensure the new version with 8 parameters exists
