...
-- Create updated leaderboard function with monthly included
...
BEGIN
  ...
  SELECT 
    ...
    (COALESCE(m.merits, 0) - COALESCE(d.demerits, 0) + COALESCE(mo.monthly, 0))::integer AS total
  FROM s
